...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await axios.post("https://bookly-backend-5qfw.onrender.com/api/auth/register", form);
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 bg-[#F0F9FF]">
        ...
        >
          <h2 className="text-3xl font-bold text-[#00477B] text-center">Register</h2>
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link to="/login" className="text-[#00477B] font-medium hover:underline">
              Login
            </Link>
          </p>
        </form>
